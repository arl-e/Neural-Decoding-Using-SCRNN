...
def plot_model_predict(model, cochains, x, y, batch_size):
	...
	np.savetxt(decoded_x_file  + ".txt", predict_x, fmt = '%1.18f', delimiter=',')
	np.savetxt(decoded_y_file  + ".txt", predict_y, fmt = '%1.18f', delimiter=',')
	...
	plt.savefig(os.path.join("../network_scripts/plots/decoded_x"  + ".pdf"))
	...
	plt.savefig(os.path.join("../network_scripts/plots/decoded_y"  + ".pdf"))
	...
	plt.savefig(os.path.join("../network_scripts/plots/error"  + ".pdf"))
...
def plot_model_predictFFNN(model, spike_count_matrix, x, y, test_stop_idx):
	...
	os.makedirs(os.path.join(sys.path[0], "plots"), exist_ok=True)
	os.makedirs(os.path.join(sys.path[0], "extracted"), exist_ok=True)

	plt.savefig(os.path.join(sys.path[0], "plots/modelFFNN_approx"  + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/modelFFNN_approx_first_minute"  + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join("C:/Users/Student/Downloads/AIMS/Hodge/SCRNN_main/grid_cell/network_scripts/plots/FFNNdecoded_x"  + ".pdf"), bbox_inches = 'tight', pad_inches = 0)
	...
	plt.margins(0,0)
	plt.savefig(os.path.join("C:/Users/Student/Downloads/AIMS/Hodge/SCRNN_main/grid_cell/network_scripts/plots/FFNNdecoded_y"  + ".pdf"), bbox_inches = 'tight', pad_inches = 0)
	...
	plt.savefig(os.path.join("C:/Users/Student/Downloads/AIMS/Hodge/SCRNN_main/grid_cell/network_scripts/plots/FFNNerror"  + ".pdf"))
...
def plot_model_predictRNN(model, seq_length, spike_count_matrix, x, y, test_stop_idx):
	...
	plt.savefig(os.path.join("../network_scripts/plots/RNNdecoded_x"  + ".pdf"))
	...
	plt.savefig(os.path.join("../network_scripts/plots/RNNdecoded_y"  + ".pdf"))
